...
import classes from "../Body/style.module.css";
import BodyContain from "./BodyContain";
import BodySpacer from "./BodySpacer";
import Container from "./Container";
import BodyFutter from "./BodyFutter";

const Header = () => {
    return (
        <div className={classes.header}>
            <div className={classes.inside__header}>
                <div className={classes.inside__header__text}>
                    <span>Home</span>
                </div>
